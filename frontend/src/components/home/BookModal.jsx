  ...
  return (
    <div className="fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center" onClick={onClose}>
        <div onClick={(event) => event.stopPropagation()} className="w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative">
            ...
            <p className="my-2">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur hic iste corrupti assumenda delectus perferendis, corporis aliquid fuga harum dolor earum accusamus at ullam blanditiis modi sunt porro rem similique distinctio dignissimos consequatur. Quae officiis libero hic dolores deleniti quod perspiciatis nisi voluptas tempora totam facilis autem, adipisci corrupti nesciunt.
            </p>    
        </div>
    </div>
  )
...
BookModal.propTypes = {
    book: PropTypes.object.isRequired, // Correct the type to object
